using System;
using Tutorial.CodeExample;

namespace Tutorial
{
    public static class ExampleRun
    {
        public static void RunExampleFirst()
        {
            ...
            // hwThird.ListCountAndCapacity();
            var market = new HwTutorialThirdClass.Market();
            Console.WriteLine(market.ProductName);
